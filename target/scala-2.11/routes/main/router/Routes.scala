...
class Routes(
  ...
  private[this] lazy val controllers_HomeController_checkout7_invoker = createInvoker(
    HomeController_0.checkout(fakeValue[Long]),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "checkout",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_HomeController_checkout7_route(params) =>
      call(params.fromQuery[Long]("id", Some(0L))) { (id) =>
        controllers_HomeController_checkout7_invoker.call(HomeController_0.checkout(id))
      }
    ...
    case controllers_HomeController_buy14_route(params) =>
      call { 
        controllers_HomeController_buy14_invoker.call(HomeController_0.buy)
      }
  
    // @LINE:23
    case controllers_CountController_count15_route(params) =>
      call { 
        controllers_CountController_count15_invoker.call(CountController_3.count)
      }
    ...
    case controllers_Assets_at18_route(params) =>
      call(Param[String]("path", Right("/public")), params.fromQuery[String]("base", None)) { (path, base) =>
        controllers_Assets_at18_invoker.call(Assets_1.at(path, base))
      }
  }
}
